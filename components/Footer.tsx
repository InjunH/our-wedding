...
const Footer: React.FC = () => {
  return (
    <footer className="py-40 px-6 bg-[#faf9f6] text-center">
      <div className="max-w-3xl mx-auto space-y-24">
        <div className="space-y-6">
          <span className="text-[10px] font-bold text-[#c5a059] tracking-[0.7em] uppercase">Gratitude</span>
          <h3 className="text-4xl md:text-5xl font-light serif-en italic tracking-tight-serif text-[#2a2a2a]">
            Always & <span className="text-[#c5a059] not-italic serif-en font-extralight">Forever</span>.
          </h3>
          <div className="h-px w-12 bg-[#c5a059] mx-auto opacity-30"></div>
        </div>
        ...
        <div className="pt-20 border-t border-[#f2f0ea] flex flex-col md:flex-row justify-center gap-20 md:gap-40">
          <div className="space-y-4">
            ...
            <p className="text-2xl font-normal serif-kr text-[#2a2a2a]">박인준</p>
            <p className="text-stone-300 serif-en text-sm tracking-widest italic">010.XXXX.XXXX</p>
          </div>
          <div className="space-y-4">
            <span className="text-[10px] font-bold text-stone-300 uppercase tracking-[0.5em] block">Bride</span>
            <p className="text-2xl font-normal serif-kr text-[#2a2a2a]">김누리</p>
            <p className="text-stone-300 serif-en text-sm tracking-widest italic">010.XXXX.XXXX</p>
          </div>
        </div>
