      ...
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        ...
        >
          ...
          <div className="w-screen h-full flex flex-col justify-center px-12 md:px-32 shrink-0 bg-white border-r border-[#f0ede6]">
            ...
            >
              <span className="text-[#c5a059] text-[10px] font-bold tracking-[0.6em] mb-6 uppercase block">Archive 01</span>
              <h2 className="text-[#333] text-6xl md:text-8xl font-medium serif tracking-tight leading-none mb-10">
                The Records<br /><span className="italic text-[#c5a059] font-light">of N & I</span>
              </h2>
              <div className="h-px w-20 bg-[#c5a059] mb-10"></div>
          ...
          {TIMELINE.map((item, index) => (
            <div 
              key={index} 
              className="w-screen h-full flex items-center justify-center px-6 md:px-24 shrink-0 relative bg-[#faf9f6] border-r border-[#f0ede6]"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 w-full max-w-6xl items-center">
                <div className="relative p-4 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.05)] rounded-sm group overflow-hidden">
                  ...
                  <div className="absolute top-10 left-10">
                     <span className="serif italic text-6xl text-[#c5a059] opacity-20 italic">0{index + 1}</span>
                  </div>
                </div>
                <div className="flex flex-col">
                  <span className="text-[#c5a059] text-xs font-bold tracking-[0.4em] uppercase mb-6">{item.date}</span>
                  <h3 className="text-4xl md:text-6xl font-medium serif italic tracking-tight mb-8 text-[#333]">{item.title}</h3>
                  <p className="text-stone-500 text-xl font-light leading-relaxed serif italic border-l-2 border-[#e5d5b7] pl-8 py-2">
                    {item.description}
                  </p>
                </div>
              </div>
          ...
          <div className="w-screen h-full flex flex-col justify-center items-center px-20 shrink-0 bg-white">
             ...
             >
               ...
               <h2 className="text-[#333] text-5xl md:text-7xl font-medium serif tracking-tight leading-tight">
                A New Chapter<br />
                <span className="italic text-[#c5a059] font-light">Begins Now</span>
              </h2>
