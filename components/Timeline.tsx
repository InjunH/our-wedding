...
const Timeline: React.FC = () => {
  ...
  return (
    <section ref={targetRef} className="relative h-[650vh] bg-[#faf9f6]">
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        ...
        >
          ...
          <div className="w-screen h-full flex flex-col justify-center px-12 md:px-32 shrink-0 bg-white border-r border-[#f2f0ea]">
            ...
            >
              <span className="text-[#c5a059] text-[10px] font-bold tracking-[0.7em] mb-8 uppercase block">Archive 01</span>
              <h2 className="text-[#2a2a2a] text-6xl md:text-8xl font-light serif-en tracking-tight-serif leading-none mb-12 italic">
                The Records<br /><span className="not-italic text-[#c5a059] font-extralight serif-en">of N & I</span>
              </h2>
          ...
          {TIMELINE.map((item, index) => (
            <div 
              key={index} 
              className="w-screen h-full flex items-center justify-center px-6 md:px-24 shrink-0 relative bg-[#faf9f6] border-r border-[#f2f0ea]"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-20 w-full max-w-6xl items-center">
                <div className="relative p-5 bg-white shadow-[0_30px_60px_rgba(0,0,0,0.04)] rounded-sm group overflow-hidden">
                  ...
                  <div className="absolute top-12 left-12">
                     <span className="serif-en italic text-7xl text-[#c5a059] opacity-15">0{index + 1}</span>
                  </div>
                </div>
                <div className="flex flex-col">
                  <span className="text-[#c5a059] text-xs font-bold tracking-[0.5em] uppercase mb-8 serif-en italic">{item.date}</span>
                  <h3 className="text-4xl md:text-6xl font-normal serif-kr tracking-tight mb-10 text-[#2a2a2a]">{item.title}</h3>
                  <div className="pl-10 border-l border-[#e5d5b7]">
          ...
          <div className="w-screen h-full flex flex-col justify-center items-center px-20 shrink-0 bg-white">
             ...
             >
               <div className="text-[#c5a059] mb-12 flex justify-center opacity-60">
               ...
               <h2 className="text-[#2a2a2a] text-5xl md:text-7xl font-light serif-en italic tracking-tight-serif leading-tight">
                A New Chapter<br />
                <span className="not-italic text-[#c5a059] font-light serif-en">Begins With You</span>
              </h2>
              <div className="mt-20">
                <span className="text-[9px] font-bold tracking-[0.6em] text-stone-300 uppercase animate-pulse">Official Invitation</span>
              </div>
             </motion.div>
          </div>
        </motion.div>
